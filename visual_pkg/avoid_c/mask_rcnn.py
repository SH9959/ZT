...
class MaskRCNN:
    ...
    def detect_objects_mask(self, bgr_frame):
        ...
        self.obj_boxes = np.concatenate(self.obj_boxes, axis=0)
        self.obj_classes = np.concatenate(self.obj_classes, axis=0)
        self.obj_contours = np.concatenate(self.obj_contours, axis=1)
        self.obj_centers = np.concatenate(self.obj_centers, axis=0)
